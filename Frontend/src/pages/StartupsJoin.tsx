      ...
      <div style={{ position: "relative" }}>
        <input
          ...
          style={{
            ...
            border: `1px solid ${error ? "#ef4444" : "#34419A"}`,
            borderRadius: 10,
            outline: "none",
            color: "#34419A",
          }}
    ...
    <main>
      ...
      <section style={{ padding: "32px 16px" }}>
        <div style={{ maxWidth: 1120, margin: "0 auto" }}>
          <h1 style={{ textAlign: "center", margin: 0, color: "#34419A" }}>
            Join
          </h1>
          <p
            style={{
          ...
          >
            Choose your path and start connecting with the right partners to
            grow your business or investment portfolio.
          </p>
          ...
          >
            ...
            >
              ...
              <form style={{ marginTop: 8 }} onSubmit={handleSubmit}>
                <Input
                  ...
                  value={fullName}
                  onChange={onChangeField(setFullName, "fullName")}
                ...
                <Input
                  ...
                  value={startupName}
                  onChange={onChangeField(setStartupName, "startupName")}
                ...
                <Input
                  ...
                  onChange={onChangeField(setCompanyWebsite, "companyWebsite")}
                ...
                <div style={{ marginBottom: 14 }}>
                  ...
                  {companyLogo && (
                    <div
                      style={{ marginTop: 8, fontSize: 12, color: "#16a34a" }}
                    >
                ...
                <Input
                  ...
                  rightIcon={
                    showPwd2 ? <EyeInvisibleOutlined /> : <EyeOutlined />
                  }
            ...
            <div
              onClick={() => navigate("/start/investor")}
              style={{
                background: "#f8fafc",
                borderRadius: 16,
                padding: 18,
          ...
          >
            ...
            <a href="#" style={{ color: "#34419A", textDecoration: "none" }}>
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="#" style={{ color: "#34419A", textDecoration: "none" }}>
