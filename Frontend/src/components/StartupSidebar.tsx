...
import { Folder, Briefcase, Users, User, CreditCard, Plus, MessageCircle, LogOut } from 'lucide-react'
...
const StartupSidebar: FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100%', padding: 16 }}>
