...
import {
  ...
  LogOut,
  Briefcase,
} from "lucide-react"; // 1. Thêm Briefcase
...
const InvestorSidebar: FC = () => {
  ...
  // 2. Cập nhật menuItems để thêm Invested Projects
  const menuItems = [
    {
  ...
  const actions = [
    ...
    },
    {
      icon: <Users size={18} />,
      label: "Join Room",
      onClick: () => navigate("/investor/room"),
    },
    {
      icon: <CreditCard size={18} />,
      label: "Manage Wallet",
      onClick: () => navigate("/investor/payments"),
    },
  ];
